          ...
          <div className="flex flex-col gap-[46px] items-center justify-start max-w-[1330px] mx-auto md:px-5 w-full">
            <div className="flex flex-col relative w-full">
              <Img
                ...
                alt="RectangleTwenty"
              />
              <div className="bg-white_A700 flex flex-col items-center justify-end mt-[-132px] mx-auto p-12 md:px-10 sm:px-5 rounded-[25px] shadow-bs3 w-[84%] z-[1]">
                <div className="flex flex-col items-start justify-start w-[97%] md:w-full">
                  <Text
                    className="font-light font-publicsans text-black_900"
                    as="h4"
                    variant="h4"
                  >
                    <span className="md:text-[22px] sm:text-xl text-bluegray_600 text-2xl text-left">
                      Category
                    </span>
                    <span className="md:text-[22px] sm:text-xl text-black_900 text-2xl text-left">
                      {" "}
                    </span>
                    <span className="md:text-[22px] sm:text-xl text-pink_300 text-2xl tracking-[0.12px] font-merriweather text-left font-bold">
                      Writing
                    </span>
                  </Text>
                  <Text
                    className="font-merriweather italic mt-[27px] text-gray_600 tracking-[0.12px] w-full"
                    as="h2"
                    variant="h2"
                  >
                  ...
                  <div className="flex sm:flex-col flex-row font-publicsans sm:gap-10 items-center justify-between mt-[50px] w-full">
                    ...
                    <Button
                      className="cursor-pointer flex items-center justify-center min-w-[191px] sm:mt-0 my-1"
                      leftIcon={
                        <Img
            ...
            <div className="flex flex-col items-start justify-start w-[74%] md:w-full">
              <div className="flex flex-col items-start justify-start w-full">
                <Text
                  className="font-light font-publicsans leading-[35.00px] text-bluegray_600 w-full"
                  as="h5"
                  variant="h5"
                >
                ...
                <div className="flex md:flex-col flex-row gap-5 items-start justify-between mt-[50px] w-[97%] md:w-full">
                  ...
                  <div className="flex flex-col gap-[15px] items-start justify-start">
                    <Text
                      className="font-bold font-merriweather italic text-bluegray_600 w-full"
                      as="h3"
                      variant="h3"
                    >
                ...
                <Text
                  className="font-light font-publicsans leading-[35.00px] mt-[50px] text-bluegray_600 w-full"
                  as="h5"
                  variant="h5"
                >
                  <span className="text-bluegray_600 text-lg text-left">
                    The game’s not big enough unless it scares you a little.
                    Wait a minute – you’ve been declared dead. You can’t give{" "}
                  </span>
                  <span className="text-bluegray_600 text-lg text-left font-bold">
                    orders around
                  </span>
                  <span className="text-bluegray_600 text-lg text-left">
                    {" "}
                ...
                <Text
                  className="font-light font-publicsans leading-[35.00px] mt-2.5 text-bluegray_600 w-full"
                  as="h5"
                  variant="h5"
                >
                  Did you come here for something in particular or just general
                ...
                <Text
                  className="font-bold font-merriweather mt-[42px] text-bluegray_600"
                  as="h4"
                  variant="h4"
                >
                ...
                <Text
                  className="font-light font-publicsans leading-[35.00px] mt-5 text-bluegray_600 w-full"
                  as="h5"
                  variant="h5"
                >
                  Did you come here for something in particular or just general
              ...
              <div className="flex flex-col gap-[15px] items-start justify-start mt-[50px] rounded-[5px] w-[52%] md:w-full">
                ...
                <div className="flex sm:flex-col flex-row gap-[15px] items-center justify-between rounded-[5px] w-full">
                  <Button
                    className="cursor-pointer font-thin leading-[normal] min-w-[96px] text-bluegray_600 text-center text-lg"
                    shape="RoundedBorder5"
                    size="md"
                    variant="FillGray200"
                  >
                  ...
                  <Button
                    className="cursor-pointer font-thin leading-[normal] min-w-[97px] text-bluegray_600 text-center text-lg"
                    shape="RoundedBorder5"
                    size="md"
                    variant="FillGray200"
                  >
                  ...
                  <Button
                    className="cursor-pointer font-thin leading-[normal] min-w-[93px] text-bluegray_600 text-center text-lg"
                    shape="RoundedBorder5"
                    size="md"
                    variant="FillGray200"
                  >
                  ...
                  <Button
                    className="cursor-pointer font-thin leading-[normal] min-w-[77px] text-bluegray_600 text-center text-lg"
                    shape="RoundedBorder5"
                    size="md"
                    variant="FillGray200"
                  >
